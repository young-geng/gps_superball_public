...
agent = {
    'type': AgentSUPERball,
    'reset': [True, False, False] * 6,
    'bottom_faces': reduce(lambda x, y: x + y, [[x] * 3 for x in xrange(6)]),
    'policy_test_horizon': 30 * 100,
    'dt': 0.1,
    ...
    'obs_include': [SUPERBALL_TRIS, SUPERBALL_TRIS_VELOCITIES, MOTOR_POSITIONS],
    'smooth_noise': True,
...
algorithm['init_traj_distr'] = {
    ...
    # 'init': ['0', '1', False, '2', '3', False, '4', '5', False, '6', '7', False, '8', '9', False, '10', '11', False],
