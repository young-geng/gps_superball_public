...
agent = {
    ...
    'obs_include': [BAR_ENDPOINT_POSITIONS, BAR_ENDPOINT_VELOCITIES, MOTOR_POSITIONS, MOTOR_VELOCITIES],
    'smooth_noise': True,
...
algorithm['cost'] = {
    'type': CostSum,
    'costs': [state_cost, state_cost2, state_cost3, torque_cost],
    'weights': [25.0, 3000.0, 10.0, 1.0],
}
