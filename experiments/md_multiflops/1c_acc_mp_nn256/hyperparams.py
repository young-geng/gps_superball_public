...
from gps.agent.ros.agent_superball import AgentSUPERball, SUPERBALL_SENSOR_DIMS, SUPERBALL_COMPUTE_VELOCITY, SUPERBALL_COMPUTE_ACCELERATION
...
agent = {
    'type': AgentSUPERball,
    'reset': [True] * 6,
    'bottom_faces': range(6),
    # 'policy_test_horizon': 30 * 24,
    'dt': 0.1,
    'conditions': common['conditions'],
    'compute_vel': SUPERBALL_COMPUTE_VELOCITY,
    'compute_accel': SUPERBALL_COMPUTE_ACCELERATION,
    'T': 50,
    'sensor_dims': SUPERBALL_SENSOR_DIMS,
    'state_include': [BAR_ENDPOINT_POSITIONS, PSEUDO_BAR_ENDPOINT_VELOCITIES, MOTOR_POSITIONS, MOTOR_VELOCITIES],
    # 'obs_include': [SUPERBALL_TRIS, SUPERBALL_TRIS_VELOCITIES, MOTOR_POSITIONS, MOTOR_VELOCITIES],
    'obs_include': [SUPERBALL_BAR_ACCELERATIONS, MOTOR_POSITIONS],
    'smooth_noise': True,
    ...
    'ctrl_vel': False,
    'sensors_dropout_rate': 0.1,
    'sensors_noise_stdddev': 0.1,
}
...
state_cost = {
    'type': CostState,
    'data_types': {
        PSEUDO_BAR_ENDPOINT_VELOCITIES: {
            'average': (12, 3),
            'wp': [-1., 1., 0.],
            'target_state': [0., 0., 0.],
        },
