...
class AlgorithmBADMM(Algorithm):
    ...
    def _update_policy(self, inner_itr):
        ...
        if 'policy_training_noise' in self._hyperparams and self._hyperparams['policy_training_noise'] > 0:
            obs_data += np.random.randn(*obs_data.shape) * self._hyperparams['policy_training_noise']
